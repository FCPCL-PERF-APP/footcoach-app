...
const FIELDS = [
  ...
  { key: 'sprints',         label: 'Sprints',     unit: '',     placeholder: '12',   step: '1',   max: 40 },
  { key: 'ballons_touches', label: 'Ballons',     unit: '',     placeholder: '47',   step: '1',   max: 120 },
  { key: 'vitesse_max',     label: 'V. max',      unit: 'km/h', placeholder: '28.5', step: '0.1', max: 40 },
  { key: 'accelerations',   label: 'Accél.',      unit: '',     placeholder: '22',   step: '1',   max: 60 },
  { key: 'distance_hi',     label: 'Dist. HI',    unit: 'm',    placeholder: '680',  step: '1',   max: 1500 },
]
